---
title: "Autenticação"
description: "Como autenticar suas requisições na API do SAN Talk AI."
---

## API Keys

Todas as requisições à API do SAN Talk AI são autenticadas via **API key**. Chaves são geradas no [Dashboard](https://talk.saninternet.com) e associadas a uma empresa.
