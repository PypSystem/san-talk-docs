...
description: "Documentação completa da API pública do SAN Talk AI."
---

A API pública do SAN Talk AI permite integrar funcionalidades de inteligência artificial e base de conhecimento a sistemas externos — chatbots, CRMs, aplicações web e mais.
