...
- **Alinhe com o [roteamento](/operacoes/roteamento)**. O SLA conta a partir do momento em que a conversa entra na fila humana — certifique-se de que a distribuição para atendentes é rápida.
