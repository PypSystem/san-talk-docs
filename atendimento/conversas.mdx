...
<Note>
  Quando o [SLA de atendimento](/operacoes/sla) está configurado, conversas transferidas para humanos exibem um relógio colorido indicando o tempo até a primeira resposta.
</Note>
